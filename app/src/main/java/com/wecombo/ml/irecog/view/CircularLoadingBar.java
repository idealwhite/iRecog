package com.wecombo.ml.irecog.view;
...
public class CircularLoadingBar extends LoadingCustomView{
    final static String ANDROIDXML = "http://schemas.android.com/apk/res/android";

    int backgroundColor = Color.parseColor("#1E88E5");


    public CircularLoadingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
